...
export class Booker {
	...
	async getUsersWithPermission(action: string) {
		const permittedRoles = (
				await prisma.bookerRole.findMany({
					where: {
...
export const eventsBooker = new Booker('events', ['view', 'organize', 'rsvp']);

export const appBooker = new Booker('app', ['user_meta', 'notifications', 'settings']);
